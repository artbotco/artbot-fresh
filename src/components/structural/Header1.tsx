            ...
            <>
                ...
                <Aside id="aside-sidebar-left" className="main-menu" side="left">
                    ...
                    <div className={"main-menu-contents"}>
                        <ul>
                            <li>
                                <Button color="secondary" size="lg" className="btn-text-light" data-section="0">
                                    Home
                                </Button>
                            </li>
                            <li>
                                <Button color="secondary" size="lg" className="btn-text-light" data-section="1">
                                    Vote
                                </Button>
                            </li>
                            <li>
                                <Button color="secondary" size="lg" className="btn-text-light" data-section="2">
                                    Crowdfund
                                </Button>
                            </li>
                            <li>
                                <Button color="secondary" size="lg" className="btn-text-light" data-section="3">
                                    Pre-production
                                </Button>
                            </li>
                            <li>
                                <Button color="secondary" size="lg" className="btn-text-light" data-section="4">
                                    Production
                                </Button>
                            </li>
                            <li>
                                <Button color="secondary" size="lg" className="btn-text-light" data-section="5">
                                    Profit!
                                </Button>
                            </li>
                        </ul>
